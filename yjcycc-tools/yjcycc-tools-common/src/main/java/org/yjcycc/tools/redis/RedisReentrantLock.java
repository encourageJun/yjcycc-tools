...
import org.yjcycc.tools.redis.lock.AbstractLock;
import org.yjcycc.tools.redis.util.LockInfo;
 ...
 * <b>Usage Example:</b>
 * <pre>
 * 	{@link org.yjcycc.tools.redis.lock.Lock} lock = new {@link RedisReentrantLock}(jedis, "lockKey", lockExpires, timeServerAddr);
